...
/***/ (function(module, exports, __webpack_require__) {
	...
	store.dispatch(_actions2.default.getContactsAPI());
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var reducer = function reducer() {
	    var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : { contacts: [], currentContact: "" };
	    var action = arguments[1];
	    ...
	    switch (action.type) {
	        ...
	        case "ADD_CONTACT":
	            return { contacts: [].concat(_toConsumableArray(state.contacts), [{ id: action.contact._id.$oid, name: action.contact.name, phone: action.contact.phone, email: action.contact.email }]),
	                currentContact: state.currentContact };
	        case "DELETE_CONTACT":
	            return { contacts: state.contacts.filter(function (contact) {
	                    return contact.id !== action.id;
	                }),
	                currentContact: state.currentContact };
	        case "SAVE_CONTACT":
	            return { contacts: state.contacts.map(function (item, index) {
	                    if (item.id == action.contact.id) return { id: action.contact._id.$oid, name: action.contact.name, phone: action.contact.phone, email: action.contact.email };else return item;
	                }),
	                currentContact: "" };
	        default:
	            return state;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _AddForm = __webpack_require__(239);

	var _AddForm2 = _interopRequireDefault(_AddForm);

	var _EditForm = __webpack_require__(240);
	    ...
	    _createClass(App, [{
	        ...
	        value: function render() {
	            if (this.props.currentContact == '') {
	                var form = _react2.default.createElement(_AddForm2.default, { addContact: this.props.onAddContact });
	            } else {
	                var form = _react2.default.createElement(_EditForm2.default, { currentContact: this.props.currentContact, onEditContact: this.props.onEditContact });
	            }
	            return _react2.default.createElement(
	                'div',
	                null,
	                form,
	                _react2.default.createElement(_ContactList2.default, this.props)
	            );
	        }
	    }]);
	...
	function mapDispatchToProps(dispatch) {
	    return {
	        onRemoveContact: function onRemoveContact(id) {
	            dispatch(_actions2.default.deleteContactAPI(id));
	        },
	        onAddContact: function onAddContact(contact) {
	            dispatch(_actions2.default.postContactAPI(contact));
	        },
	        onBeginUpdateContact: function onBeginUpdateContact(contact) {
	            dispatch(_actions2.default.beginUpdateContact(contact));
	        },
	        onEditContact: function onEditContact(contact) {
	            dispatch(_actions2.default.updateContactAPI(contact));
	        }
	    };
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var getContacts = function getContacts(contacts) {
	    return {
	        type: "GET_CONTACTS",
	        contacts: contacts
	    };
	...
	var beginUpdateContact = function beginUpdateContact(contact) {
	    return {
	        type: "UPDATE_CONTACT",
	        contact: contact
	    };
	...
	var saveEditContact = function saveEditContact(contact) {
	    return {
	        type: "SAVE_CONTACT",
	        contact: contact
	    };
	...
	function getContactsAPI() {
	    return function (dispatch) {
	        return (0, _axios2.default)({
	            ...
	            return dispatch(getContacts(response.data));
	        });
	    };
	}
	...
	function updateContactAPI(contact) {
	    return function (dispatch) {
	        return (0, _axios2.default)({
	            ...
	            return dispatch(saveEditContact(response.data));
	        });
	    };
	}
	...
	module.exports = { getContactsAPI: getContactsAPI, postContactAPI: postContactAPI, updateContactAPI: updateContactAPI, deleteContactAPI: deleteContactAPI, beginUpdateContact: beginUpdateContact };
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement('input', { type: 'text', ref: 'name', className: 'form-control', placeholder: 'Add name' })
	                    ),
	                    _react2.default.createElement(
	                        'div',
	                        { className: 'form-group' },
	                        _react2.default.createElement('input', { type: 'text', ref: 'phone', className: 'form-control', placeholder: 'Add phone' })
	                    ),
	                    _react2.default.createElement(
	                        'div',
	                        { className: 'form-group' },
	                        _react2.default.createElement('input', { type: 'text', ref: 'email', className: 'form-control', placeholder: 'Add email' })
	                    ),
	                    _react2.default.createElement(
	                        'button',
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var EditForm = function (_React$Component) {
	    ...
	    _createClass(EditForm, [{
	        key: "onChange",
	        value: function onChange(property, event) {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        "div",
	                        { className: "form-group" },
	                        _react2.default.createElement("input", { type: "text", ref: "name", onChange: this.onChange.bind(this, "name"), value: this.props.currentContact.name, className: "form-control", placeholder: "Edit name" })
	                    ),
	                    _react2.default.createElement(
	                        "div",
	                        { className: "form-group" },
	                        _react2.default.createElement("input", { type: "text", ref: "phone", onChange: this.onChange.bind(this, "phone"), value: this.props.currentContact.phone, className: "form-control", placeholder: "Edit phone" })
	                    ),
	                    _react2.default.createElement(
	                        "div",
	                        { className: "form-group" },
	                        _react2.default.createElement("input", { type: "text", ref: "email", onChange: this.onChange.bind(this, "email"), value: this.props.currentContact.email, className: "form-control", placeholder: "Edit email" })
	                    ),
	                    _react2.default.createElement(
	                        "button",
	                        { type: "submit", className: "btn btn-primary" },
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        this.props.contacts.map(function (contact, index) {
	                            return _react2.default.createElement(_Contact2.default, { contact: contact, key: index, onRemoveContact: componentProps.onRemoveContact, onBeginUpdateContact: componentProps.onBeginUpdateContact });
	                        })
	                    )
	                )
	            );
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Contact = function (_React$Component) {
	    ...
	    _createClass(Contact, [{
	        key: "handleEdit",
	        value: function handleEdit(contact) {
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        "a",
	                        { className: "btn btn-primary", href: "#", onClick: this.handleEdit.bind(this, this.props.contact) },
	                        "EDIT"
	                    ),
	                    "\xA0",
	                    _react2.default.createElement(
	                        "a",
	                        { className: "btn btn-danger", href: "#", onClick: this.handleRemove.bind(this, this.props.contact.id) },
	                        "REMOVE"
	                    )
	                )
	            );
